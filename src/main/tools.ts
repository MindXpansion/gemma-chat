...
export function chatSystemPrompt(enableTools: boolean): string {
  ...
  return [
    ...
    '  3. You will then receive a [tool result] message containing the result text.',
    '  4. Read the result. NARRATE IT TO BEAR in plain text. DO NOT re-invoke the same tool — the result you have IS the answer.',
    '  5. Only call another tool if you genuinely need ANOTHER piece of information.',
    '  6. When fully done, write a short plain-text closing and emit no more actions.',
    '',
